...
/**
 * Расписания подогрева по температуре салона. Значения настроены по живым
 * поездкам — менять их нельзя.
 *
...
final class TemperatureConstants {
    ...
    /**
     * Температура одним видом для экрана и лога. Locale.US обязателен: в русской
     * локали разделителем стала бы запятая.
     */
